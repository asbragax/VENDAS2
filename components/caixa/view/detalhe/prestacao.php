    ...
    <div class="invoice-content">
        ...
        <div class="table-responsive mt-50px pt-50px">
            <table class="table table-invoice">
                <thead>
                    <tr class="border-bottom border-2 border-dark">
                        ...
                        <th><strong>Vendedor:</strong> <br><?php echo $venda['nome_vendedor']; ?></th>
                    </tr>
                    <tr class="border-bottom border-2 border-dark">
                        ...
                        <?php if($JUROS == 1){ ?> <th><strong>Juros: </strong><br><?php echo "R$ " . number_format($conta['juros'] / 100, 2, ',', '.'); ?></th>
                        <th><strong>Total: </strong><br><?php echo "R$ " . number_format(($conta['juros']+$conta['valor_pag']) / 100, 2, ',', '.'); ?></th><?php } ?>
                    </tr>
                    <tr class="border-bottom border-2 border-dark">
                        <th colspan="4"><strong>Observação: </strong> <br><?php echo $conta['observacao']; ?></th>
                    </tr>
                </thead>
            </table>
            <?php if($vendedor == 1){ ?>
            ...
            <div class="invoice-price">
                <div class="invoice-price-left">
                    <div class="invoice-price-row">
                        <div class="sub-price">
                            ...
                            <span class="text-inverse">R$ <?php echo number_format($venda['valor']/100, 2, ",", '.'); ?></span>
                        </div>
                        <div class="sub-price">
                ...
                <div class="invoice-price-right">
                    <small>TOTAL</small> <span class="fw-bold">R$ <?php echo number_format(($venda['valor']-$venda['desconto'])/100, 2, ",", '.'); ?></span>
                </div>
            </div>
            <?php } ?>
            <div class="table-responsive">
                ...
                <table class="table table-invoice">
                    ...
                    <thead class="pt-35px">
                        <tr>
                            <th class="text-center fs-18px" colspan="7">Parcelas</th>
                        </tr>
                        <tr class="text-center">
                            <th>#</th>
                            <th>Valor parcela</th>
                            <?php if($JUROS == 1){ ?> <th>Juros</th>
                            <th>Total</th><?php } ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php if($JUROS == 1){ ?> <td class="text-center">R$ <?php echo $juros == 1 ? number_format($valor_juros/100, 2, ",", '.') : number_format($parcelas[$i]['juros']/100, 2, ",", '.'); ?></td>
                            <td class="text-center">R$ <?php echo $juros == 1 ? number_format(($parcelas[$i]['valor_pag']+$valor_juros)/100, 2, ",", '.') : number_format(($parcelas[$i]['valor_pag']+$parcelas[$i]['juros'])/100, 2, ",", '.'); ?></td><?php } ?>
                            <td class="text-center"><span class="text-inverse"><?php echo $parcelas[$i]['vencimentof']; ?></span></td>
                            <td class="text-center"><span class="text-inverse"><?php echo $parcelas[$i]['flag'] == 1 ? $parcelas[$i]['data_pagf'] : ""; ?></span></td>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <?php if($JUROS == 1){ ?> <th class="text-end"></th>
                            <th class="text-end"></th><?php } ?>
...
$(document).ready(function() {
    $(document).on("click", ".btnRecibo", function() {
        ...
        $.post("components/caixa/view/export/recibo_pagamento.php", dados,
            function(data) {
                // console.log(data);
                debugger
                if (data != false) {
