...
$vencidas = $dao->listar_emaberto_vendedor_cliente($dataini, $datafim, $vendedor, $cliente);
...
<div class="invoice">
    ...
    <div class="invoice-company">
        ...
        <?php echo $EMPRESA_REDUZIDO; ?> - RELATÓRIO DE VALORES A RECEBER
    </div>
    <!-- END invoice-company -->
        ...
        <div class="table-responsive">
            <table class="table table-invoice">
                <thead class="bg-primary">
                    ...
                    <?php echo $JUROS == 1 ? '<th>Valor</th><th>Juros</th>' : ''; ?>
                    <th>Total</th>
                    <th>Vencimento</th>
...
$(document).ready(function(){
    ...
    $(document).on("click", ".btnRecibo", function() {
        ...
        // console.log(dados);
        $.post("components/relatorio/export/areceber.php", dados,
            function(data) {
                console.log(data);
                debugger
                if (data != false) {
