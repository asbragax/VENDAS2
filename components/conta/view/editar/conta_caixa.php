...
$conta = $dao->getPorId($_GET['edtContaCaixa']);

include_once('components/conta/action/editar_contacaixa.php'); ?>
<div class="col-xl-12">
    <div id="panel-1" class="panel">
        <div class="panel-hdr">
            <h2>
                <i class='subheader-icon fa fa-comments-dollar me-1'></i> Editar <span class="fw-300"><i>conta caixa</i></span>
            </h2>
            <div class="panel-toolbar">
                <a href="?consContaCaixa" class="btn btn-info btn-sm btn-pills">Ver contas caixa</a>
            </div>
        </div>
