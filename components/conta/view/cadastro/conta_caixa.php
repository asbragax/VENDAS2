<?php include_once('components/conta/action/cadastrar_contacaixa.php'); ?>
<div class="col-xl-12">
    <div id="panel-1" class="panel">
        <div class="panel-hdr">
            <h2>
                <i class='subheader-icon fa fa-comments-alt-dollar me-1'></i> Nova <span class="fw-300"><i>conta caixa</i></span>
            </h2>
