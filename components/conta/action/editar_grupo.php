<?php
      ...
      if ( isset($_POST['salvar']) ) {
        ...
        $gravou = $dao->alterar($grupo, $_POST['oldid']);
        if ($gravou) {
            ?>
    <div class="alert border-faded bg-transparent text-secondary fade show" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-1">
                <span class="h5 color-success-600">Grupo editado com sucesso!</span>
                <br>
    ...
    <meta http-equiv="refresh" content="0;URL=?edtGrupo=<?php echo $_POST['id']; ?>">
    <?php
        } else { ?>
