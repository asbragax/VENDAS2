<?php
      ...
      if ( isset($_POST['salvar']) ) {
        ...
        $categoria->setCc($_POST['cc'] != '' ? $_POST['cc'] : strtoupper(uniqidReal(25)));
        $categoria->setCc_reduzido($_POST['cc_reduzido'] != ''  ? $_POST['cc_reduzido'] : strtoupper(uniqidReal(25)));
        $categoria->setGrupo($_POST['grupo']);
       

        $gravou = $categoria->grava();
        if ($gravou) {
            ?>
    <div class="alert border-faded bg-transparent text-secondary fade show" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div class="flex-1">
                <span class="h5 color-success-600">Categoria com sucesso!</span>
                <br>
