...
include_once('components/devolucao/action/cadastrar_devolucao.php'); 
?>

<div class="panel panel-inverse">
  <div class="panel-heading">
    <h4 class="panel-title">Nova Devolução/Troca</h4>
        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data" role="form">
            <div class="row">
                ...
                <div class="col-md-3 form-group mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" id="troca" name="tipo" value="2" />
                        <label class="form-check-label" for="troca">Troca</label>
                    </div>
                </div>
                <div class="col-md-12">
                    <label class="form-label">Observação</label>
                    <textarea class="form-control border-primary" rows="6" name="obs" id="obs"></textarea>
                </div>
            </div>
