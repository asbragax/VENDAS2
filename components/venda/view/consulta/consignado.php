<?php 
$dao = new VendaDAO();
$listaVendas = $dao->listar_prevenda();
?>
<div class="btn-group w-100">
  <a href="?consVendaConsignado" class="btn btn-purple active">Consignado</a>
...
<div class="panel panel-inverse">
    <div class="panel-heading">
        <h4 class="panel-title">Lista de vendas em aberto</h4>
            ...
            <table id="table-consignados" class="table table-bordered table-hover table-striped w-100">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th></th>
                        <th>TOTAIS</th>
                        <th>R$ <?php echo number_format((array_sum(array_column($listaVendas,"valor"))+array_sum(array_column($listaVendas,"desconto")))/100, 2, ",", "."); ?></th>
                        <th>QUANTIDADE</th>
                        <th><?php echo count($listaVendas); ?></th>
