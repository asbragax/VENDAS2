                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <!-- <button class="confirmImprimir btn btn-sm btn-icon btn-default" name="ticket_venda" value="id=<?php echo $listaVendas[$i]["id"]; ?>">
                                    ...
                                    <a class="btn btn-sm btn-icon btn-info" href="?dtlVenda=<?php echo $listaVendas[$i]["id"]; ?>">
...
$(document).ready(function() {
    ...
    $("#table-concluidas").on("click", ".confirmDeletar", function() {
        var dados = $(this).val();
